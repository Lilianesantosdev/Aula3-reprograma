...
function somarMultiplicar() {
  const resultadoSoma = soma(9824, 777)
  return multiplicacao(36325, resultadoSoma)
}
console.log(somarMultiplicar())


// 5) crie uma função que receba dois números e gere outros dois números aleatórios com valores entre eles.
//Exemplo: uma função que receba (1, 100) deve gerar dois números aleatórios entre 1 e 100 (por exemplo, 54 e 12). 
//Em seguida, some estes números e devolva uma string com o resultado no formato: "a soma de [número aleatório] e [número aleatório] é XXX". 
...
function somarNumerosAleatorios(numero1, numero2) {
  const numeroAleatorio1 = gerarNumerosAleatorios(numero1, numero2)
  const numeroAleatorio2 = gerarNumerosAleatorios(numero1, numero2)
  console.log(numeroAleatorio1)
  console.log(numeroAleatorio2)
  return soma(numeroAleatorio1, numeroAleatorio2)
}
console.log(somarNumerosAleatorios(1, 100))
...
function multiplicarSomar(numero1, numero2, numero3) {
...
console.log(multiplicarSomar(5, 2, 2))
console.log(multiplicarSomar(5, 2))
...
function inverterPalavra(nome) {
  return nome.split('').reverse().join('')
}
console.log(inverterPalavra('ravi'))
...
console.log(palindromo("liliane"))
...
console.log(compararPalavras('banana', 'chocolate'))
